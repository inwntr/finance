    ...
    <main className="app-layout">
      <aside className="sidebar">
        ...
        <footer className="sidebar-footer">
          <small>
            <a href="https://github.com/inwntr" target="_blank" rel="noreferrer">Powered by: Winter</a> © {year} | <a href="https://haonfinance.netlify.app/" target="_blank" rel="noreferrer">My Finance</a>. All rights reserved.
          </small>
        </footer>
      </aside>
